...
from .model import EmbeddingModel, GeneralEmbedding, ModelLabel, PuffEmbedding, GteQwenEmbedding


TASK_INSTRUCT = "给定一个描述，告诉我意思最接近的成语"

def batch_embedding(
    model_label: ModelLabel, chunks: Iterable[pd.DataFrame], device: torch.device, instruct: bool = False
) -> NDArray:
    ...
    elif model_label is ModelLabel.Tao or model_label is ModelLabel.GteLargeZh:
